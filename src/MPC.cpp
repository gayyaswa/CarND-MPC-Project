...
// Set the timestep length and duration based on lessons for now
size_t N = 10;
double dt = 0.1;
...
// so that solver can read this correctly
size_t x_start = 0;
...
public:
	...
	void operator()(ADvector& fg, const ADvector& vars) {
		...
		//'fg[0]' hold the cost value based on lessons.
		fg[0] = 0;
		...
		//
		// 1 is added to each of the starting indices due to cost being located at
...
//	vars[epsi_start] = epsi;
	...
	//push steering and actuation values for next step
	result.push_back(solution.x[delta_start]);
	result.push_back(solution.x[a_start]);

	//Actual position of future points from the controller.
	for(int i = 0; i < N-1; ++i)
	{
